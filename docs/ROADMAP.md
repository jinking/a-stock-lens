...
- [ ] **全市场日线落地**（AkShare，名单实测 5,565 只）：跑完才能做真正的全市场日扫。当前本机已落地 5 只真实日线（22,693 根，覆盖 1991-04-03 至 2026-09-17）加 fixture；实测单标的约 1.82 秒，串行外推全市场约 164 分钟。缺的是分块落地与断点续跑（本计划的 Task 4）。
